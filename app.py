...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get(
    'DATABASE_URL',
    'postgresql+psycopg2://business_visit_db_user:Q71xLb5KKA9qbnNv6yafOXym8GJc3ySU@dpg-d30m5jh5pdvs7386gq00-a.oregon-postgres.render.com/business_visit_db?sslmode=require'
)
